...
namespace HexaControl.Areas.Admin.Controllers
{
    ...
    public class ContactsController : Controller
    {
        ...
        public ContactsController(HexaConDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Email,Massege")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Email,Massege")] Contact contact)
        {
            if (id != contact.Id)
            {
                return NotFound();
